...
def do_plot(x, y, z, val, r, labels, mode='G', save=True, markersize = 50):
	...
	sc = ax.scatter(x, y, z, c=r, cmap=mymap, norm=cls.LogNorm(), 
		vmin=vmin, vmax=vmax, lw=0.5, edgecolors='black', marker='o', s=markersize, alpha=1., rasterized=False)   
