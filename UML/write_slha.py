...
# PDG code           mass       particle
   ...
   2000004     {mQ}   # ~c_R
   1000005     {mQ3}   # ~b_1
   2000005     8.17899935E+04   # ~b_2
   1000006     {mQ3}   # ~t_1
   2000006     8.09750859E+04   # ~t_2
   1000011     3.18305992E+04   # ~e_L
   2000011     1.86764613E+04   # ~e_R
   1000012     3.18215047E+04   # ~nu_eL
   1000013     3.18305992E+04   # ~mu_L
   2000013     1.86764613E+04   # ~mu_R
   1000014     3.18215047E+04   # ~nu_muL
   1000015     1.84202422E+04   # ~tau_1
   2000015     3.17599786E+04   # ~tau_2
   1000016     3.17492294E+04   # ~nu_tauL
   1000021     {mG}   # ~g
   1000022     {mN1}   # ~chi_10
   1000023     4.14153268E+04   # ~chi_20
   1000025    -4.71551932E+04   # ~chi_30
   1000035     4.72187638E+04   # ~chi_40
   1000024     4.14152888E+04   # ~chi_1+
   1000037     4.72164393E+04   # ~chi_2+
#
BLOCK SU_LOWPAR  # Values constrained by exp data 
         1     5.50373935E-05   # Delta rho parameter
         2     8.55032748E-12   # g_mu -2
         3     3.19844829E-04   # Br(b -> s gamma)
#
BLOCK SU_FINETUNE  # Fine-tuning info: fine-tuned if >>1
         1     5.50789538E+03   # delta mZ^2/mZ^2 (mu^2)
         2     1.50650707E+02   # delta mZ^2/mZ^2 (B.mu)
         3     2.75396145E+03   # delta mt/mt (mu^2)
         4     7.53152523E+01   # delta mt/mt  (B.mu)
#
...
BLOCK STOPMIX  # Stop Mixing Matrix
  1  1     0.7071067812   # cos(theta_t)
  1  2     0.7071067812   # sin(theta_t)
  2  1    -0.7071067812   # -sin(theta_t)
  2  2     0.7071067812   # cos(theta_t)
#
BLOCK SBOTMIX  # Sbottom Mixing Matrix
  1  1     0.7071067812   # cos(theta_b)
  1  2     0.7071067812   # sin(theta_b)
  2  1    -0.7071067812   # -sin(theta_b)
  2  2     0.7071067812   # cos(theta_b)
#
...
BLOCK Yu Q=  7.28047708E+03  # The Yukawa couplings
  3  3     7.92398223E-01   # y_top(Q) DRbar
#
...
#
BLOCK MSOFT Q=  7.28047708E+03  # soft SUSY breaking masses at the scale Q
